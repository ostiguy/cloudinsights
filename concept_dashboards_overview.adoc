...
summary: Create custom dashboards with flexible widgets to visualize infrastructure data, monitor performance trends, and build operational views tailored to your specific monitoring needs.
...
[.lead]
Create custom dashboards that deliver the operational insights you need most. Choose from multiple widget types—including tables, charts, gauges, and plots—to visualize your infrastructure data exactly how you want it, enabling better decision-making and more effective monitoring.
