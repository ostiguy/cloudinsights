...
summary: Import pre-built dashboards from the gallery to quickly gain business insights, or import custom dashboards you've exported to share configurations across tenants.
...
[.lead]
Access pre-built dashboards from the gallery to quickly gain insights into your infrastructure, or import custom dashboards you've exported from other tenants. Gallery dashboards are tailored to your environment's data collectors and designed to answer specific business questions, while exported dashboards let you share useful configurations across multiple tenants.
