...
If you notice that your AU is blocked trying to connect to DII, try adding these endpoints to your proxy:

 api.bluexp.netapp.com
 netapp-cloud-account.auth0.com

More information on proxy configuration can be found in the NetApp link:https://kb.netapp.com/Cloud/ncds/nds/dii/dii_kbs/Where_is_the_proxy_information_saved_to_in_the_Cloud_Insights_Acquisition_Unit[Knowledgbase].

Specific NetApp Console proxy endpoints you may need are listed in the link:https://docs.netapp.com/us-en/console-setup-admin/reference-networking-saas-console-previous.html#update-endpoint-list[Console Setup Admin] documentation.
