...
summary: Export query results, dashboard tables, landing page and other data to .CSV files for external analysis, reporting, and integration with other applications using asynchronous processing.
...
[.lead]
Export data to .CSV files from queries, dashboard table widgets, and landing page tables for external analysis, reporting, and integration with other applications. The asynchronous export process allows you to continue working while large datasets are processed in the background.
