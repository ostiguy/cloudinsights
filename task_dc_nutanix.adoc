...
summary: Configuring Nutanix NX data collector.
---
...
[.lead] 
Data Infrastructure Insights uses the Nutanix NX data collector to discover inventory and performance data for Nutanix NX storage systems.
