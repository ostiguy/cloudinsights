...
* IP address of the Red Hat OpenShift Virtualization server over port 6443 via REST API 
...
|===
|Field | Description
|HTTPS Communication Port|Port used for HTTPS communication to RHOV. Default is 6443.
