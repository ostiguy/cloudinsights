...
* Port 443 (or 8443 if configured)
...
|===
|Field|Description
|StorageGRID Host IP Address |Management IP address of the StorageGRID (Grid Manager)
|User Name |Name used to log into the StorageGRID (Grid Manager)
|Password |Password used to log into the StorageGRID (Grid Manager)
|===
