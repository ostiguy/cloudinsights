...
[.lead]
<<<<<<< HEAD
The Workload Security Alerts page provides a comprehensive timeline of potential attacks and warnings with detailed investigation tools. View alert details, manage status updates, filter by criteria, and track user activities to efficiently investigate and respond to security incidents. 
=======
...
>>>>>>> ebbce31788f37dd07655cf430074e27924c7c079
...
* The _Potential Attack_ type (for example, File Tampering or Sabotage)
...
image:RansomwareAlertExample.png[file tampering Alert Example]

Detail page (this example shows a potential file tampering attack):
image:RansomwareDetailPageExample.png[file tampering Detail Page Example]
...
You can define link:cs_automated_response_policies.html[automated response policies] that take a snapshot when file tampering attack or other abnormal user activity is detected.
