...
* User Access data
+
Authentication and access information that allows NetApp Console to communicate with regional Data Infrastructure Insights sites, including data related to user Authorization. 
...
* Information that allows NetApp Console to communicate with regional Data Infrastructure Insights sites, including anything to do with user Authorization.
...
You can read more about NetApp's privacy and security at the * NetApp link:https://www.netapp.com/responsibility/trust-center/[Trust Center].
