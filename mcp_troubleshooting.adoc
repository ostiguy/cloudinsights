...
Do not repeat the values. Summarize only target names, integration types, counts, and status. Follow link:security.adoc[Security and privacy] if secret material was displayed or shared.
...
For common investigations, start from an link:recipes/index.adoc[operational recipe].
