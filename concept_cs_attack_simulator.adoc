...
summary: Test and validate Workload Security detection capabilities by simulating attacks using the included simulation script to verify alert generation and response policies.
---
