...
summary: Configure automated response policies to take action during security incidents, including snapshots, user access restriction, and webhook notifications for ransomware and other attacks.
=======
keywords: alert, snapshot, ransomware, attack, tampering
summary: Configure automated response policies to take immediate action during security incidents, including snapshots, user access restriction, and webhook notifications for threats and suspicious behavior.
...
image:ws_add_attack_policy.png[Add an Attack Policy dialog showing webhook dropdown, width=300]
