...
<<<<<<< HEAD
summary: Configure email notifications for Workload Security alerts, warnings, agent health monitoring, and system upgrades to ensure timely awareness of security threats and system status.
=======
summary: Configure email notifications to receive alerts about potential attacks, security warnings, and Agent/Data Collector health status in real-time.
...
[.lead]
<<<<<<< HEAD
Stay informed about security threats and system health with comprehensive email notifications from Workload Security. Configure recipients for attack alerts, warnings, agent health monitoring, and upgrade notifications to ensure your team responds promptly to critical events and maintains optimal system performance.
=======
