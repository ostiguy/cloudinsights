...
** Install link:http://ldaptool.sourceforge.net/[LDAP Explorer] or link:http://jxplorer.org/[Java LDAP Explorer] on any windows machine which can connect to the LDAP Server.
