...
summary: System-defined monitors provide pre-configured alerting for common performance, infrastructure, and log conditions across your environment.
---
...
[.lead]
Data Infrastructure Insights provides pre-configured system monitors that automatically alert on common performance, infrastructure, and log conditions. These monitors come with predefined thresholds, descriptions, and corrective actions to help you quickly identify and resolve issues. The available monitors depend on your configured data collectors.
...
Below are the system monitors included with Data Infrastructure Insights:
