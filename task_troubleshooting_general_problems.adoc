...
|I have a Console account but am unable to log in.
|Open a ticket from https://mysupport.netapp.com/site/help. Select category console.netapp.com > Account/Login issues” or console.netapp.com > Federation issues”.  These are specifically for Console issues or questions.
...
|Verify that you have signed up for a Console account, or that your organization uses SSO login with Console.

Verify your Console profile email address matches email address shown in your Data Infrastructure Insights welcome email. If the email does not match, request a new invitation with the correct email address.

|I logged out from Console and was automatically logged out from Data Infrastructure Insights. |Single Sign-On (SSO) across NetApp Cloud Services logs out all Data Infrastructure Insights sessions. If you have access to multiple Data Infrastructure Insights accounts, logging out from any one logs out all active sessions. Log back in to access your account.

|I was automatically logged out after several days.
|NetApp Cloud accounts require reauthentication every few days (current Console setting is 7 days). Log back in to access your account.
...
Verify your Console profile email address matches email address shown in your Data Infrastructure Insights welcome email
...
Additional troubleshooting tips may be found in the link:https://kb.netapp.com/Cloud/ncds/nds/dii/dii_kbs[NetApp Knowledgebase] (support sign-in required).
...
link:https://www.netapp.com/company/contact-us/support/[Phone]
