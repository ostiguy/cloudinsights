...
|AFX-1K
|NetApp Release 9.19.1: Sat Jul 18 20:33:10 UTC 2026
NetApp Release 9.19.1RC1: Sat May 02 12:38:22 UTC 2026
...
.144+|foundation .4+|Capability|Active|Implemented|HTTPS|
...
.7+|File Share|Is InternalVolume|Implemented|HTTPS|whether the file share represents an internal volume (netapp volume) or is it a qtree/folder within the internal volume
...
.31+|Internal Volume|Compression Enabled|Implemented|HTTPS|Is compression enabled on the storage pool
...
.8+|QTree|Name|Implemented|HTTPS|
|Qtree Id|Implemented|HTTPS|unique id of the qtree
...
|Status|Implemented|HTTPS|
|Type|Gap|HTTPS|
.10+|Quota|Hard Capacity Limit (MB)|Implemented|HTTPS|max amount of disk space, allowed for the quota target (Hard limit)
...
.115+|performance .11+|Disk|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
...
|Server ID|Implemented|HTTPS|
.20+|Storage|Failed Raw Capacity|Implemented|HTTPS|
...
|Throughput Total|Implemented|HTTPS|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|HTTPS|
.16+|Storage Node|Failed Disks|Implemented|HTTPS|
...
|Utilization Total|Implemented|HTTPS|
.16+|StoragePool Disk|Capacity Provisioned|Implemented|HTTPS|
|Raw Capacity|Implemented|HTTPS|
...
|Utilization Total|Implemented|HTTPS|
|Utilization Write|Implemented|HTTPS|
.13+|Virtual Machine|Total Capacity|Implemented|HTTPS|
|Used Capacity|Implemented|HTTPS|
|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
...
|Originator ID|Implemented|HTTPS|
|Originator Key|Implemented|HTTPS|
.29+|performance .12+|Virtual Disk|Total Capacity|Implemented|HTTPS|
|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
|Key|Implemented|HTTPS|
...
|Type|Gap|HTTPS|
|Virtual|Implemented|HTTPS|Is this a storage virtualization device?
.18+|performance .6+|Internal Volume|Total Capacity|Implemented|HTTPS|
|Used Capacity|Implemented|HTTPS|
|Capacity Used Ratio|Implemented|HTTPS|
|Key|Implemented|HTTPS|
...
|Key|Implemented|HTTPS|
|Server ID|Implemented|HTTPS|
.4+|StoragePool Disk|Capacity Provisioned|Implemented|HTTPS|
|Raw Capacity|Implemented|HTTPS|
|Total Capacity|Implemented|HTTPS|
|Over Commit Capacity Ratio|Implemented|HTTPS|Reported as a time series
...
.223+|foundation .4+|Capability|Active|Implemented|HTTPS|
|Licensed|Implemented|HTTPS|
|Type|Gap|HTTPS|
|Used|Implemented|HTTPS|
.6+|Disk Group|Capacity|Implemented|HTTPS|
|DiskGroup Id|Implemented|HTTPS|
|Name|Implemented|HTTPS|
|Physical Disk Capacity (MB)|Implemented|HTTPS|
|Used Capacity|Implemented|HTTPS|
|Virtual|Implemented|HTTPS|
.8+|File Share|Is InternalVolume|Implemented|HTTPS|
|Is Oplocks Enabled|Implemented|HTTPS|
|Is Shared|Implemented|HTTPS|
|Name|Implemented|HTTPS|
|Path|Implemented|HTTPS|
|Qtree Id|Implemented|HTTPS|
|Security Type|Implemented|HTTPS|
|Status|Implemented|HTTPS|
...
.6+|Info|Api Name|Implemented|HTTPS|
|Api Version|Implemented|HTTPS|
|DataSource Name|Implemented|HTTPS|
|Date|Implemented|HTTPS|
|Originator ID|Implemented|HTTPS|
|Originator Key|Implemented|HTTPS|
.41+|Internal Volume|Compression Enabled|Implemented|HTTPS|
|Compression Savings|Implemented|HTTPS|
|Data Allocated Capacity|Gap|HTTPS|
|Data Used Capacity|Implemented|HTTPS|
|Dedupe Enabled|Implemented|HTTPS|
|Dedupe Savings|Implemented|HTTPS|
|GuidKey 1|Implemented|HTTPS|
|GuidKey 2|Implemented|HTTPS|
|Internal Volume Id|Implemented|HTTPS|
|Last Known Access Time|Implemented|HTTPS|
|Name|Implemented|HTTPS|
|Protection Type|Implemented|HTTPS|
|Raw to Usable Ratio|Implemented|HTTPS|
|Snapshot Allocated Capacity|Gap|HTTPS|
|Snapshot Count|Implemented|HTTPS|
|Snapshot Used Capacity|Implemented|HTTPS|
|Space Guarantee|Implemented|HTTPS|
|Status|Implemented|HTTPS|
|Storage Pool Id|Implemented|HTTPS|
|Thin Provisioned|Implemented|HTTPS|
|Thin Provisioning Supported|Implemented|HTTPS|
|Total Allocated Capacity|Implemented|HTTPS|
|Total Clone Saved Capacity in MB|Implemented|HTTPS|
|Total Used Capacity|Implemented|HTTPS|
|Total Used Capacity (MB)|Implemented|HTTPS|
|Type|Gap|HTTPS|
|UUID|Implemented|HTTPS|
|Virtual Storage|Implemented|HTTPS|
...
|Technology|Implemented|HTTPS|
.12+|QTree|GuidKey 1|Implemented|HTTPS|
|GuidKey 2|Implemented|HTTPS|
|GuidKey 3|Implemented|HTTPS|
|Name|Implemented|HTTPS|
|Oplocks|Implemented|HTTPS|
|Qtree Id|Implemented|HTTPS|
|Quota HardCapacity Limit (MB)|Implemented|HTTPS|
|Quota SoftCapacity Limit (MB)|Implemented|HTTPS|
|Quota UsedCapacity|Implemented|HTTPS|
|Security Style|Implemented|HTTPS|
|Status|Implemented|HTTPS|
|Type|Gap|HTTPS|
.15+|Quota|GuidKey 1|Implemented|HTTPS|
|GuidKey 2|Implemented|HTTPS|
|GuidKey 3|Implemented|HTTPS|
|Hard Capacity Limit (MB)|Implemented|HTTPS|
|Hard File Limit|Implemented|HTTPS|
|Internal Volume Id|Implemented|HTTPS|
|Qtree Id|Implemented|HTTPS|
|Quota Id|Implemented|HTTPS|
|Soft Capacity Limit (MB)|Implemented|HTTPS|
|Soft File Limit|Implemented|HTTPS|
|Threshold (MB)|Implemented|HTTPS|
|Type|Gap|HTTPS|
|Used Capacity|Implemented|HTTPS|
|Used Files|Implemented|HTTPS|
|User/Group Target|Implemented|HTTPS|
.4+|Share|Description|Implemented|HTTPS|
|IP Interfaces|Implemented|HTTPS|
|Name|Implemented|HTTPS|
|Protocol|Implemented|HTTPS|
.2+|Share Initiator|Initiator|Implemented|HTTPS|
|Permission|Implemented|HTTPS|
.18+|Storage|Cluster|Not Available|HTTPS|
|Cpu Count|Implemented|HTTPS|
|Display IP|Implemented|HTTPS|
|Failed Raw Capacity|Implemented|HTTPS|
|Family|Implemented|HTTPS|
|IP|Implemented|HTTPS|
|Manage URL|Implemented|HTTPS|
|Manufacturer|Implemented|HTTPS|
|Memory|Implemented|HTTPS|
...
|Model|Implemented|HTTPS|
|Name|Implemented|HTTPS|
|Total Raw Capacity|Implemented|HTTPS|
|Serial Number|Implemented|HTTPS|
|Spare Raw Capacity|Implemented|HTTPS|
|SupportActive Active|Implemented|HTTPS|
|Virtual|Implemented|HTTPS|
|UUID|Implemented|HTTPS|
.10+|Storage Node|Cache Size|Implemented|HTTPS|
|Memory Size|Gap|HTTPS|
|Model|Implemented|HTTPS|
|Name|Implemented|HTTPS|
|Processors Count|Implemented|HTTPS|
|Serial Number|Implemented|HTTPS|
|State|Implemented|HTTPS|
|UUID|Implemented|HTTPS|
|Up Time|Implemented|HTTPS|
|Version|Implemented|HTTPS|
.29+|Storage Pool|Compression Enabled|Implemented|HTTPS|
|Compression Savings|Implemented|HTTPS|
|Data Allocated Capacity|Gap|HTTPS|
|Data Used Capacity|Implemented|HTTPS|
|Dedupe Enabled|Implemented|HTTPS|
|Dedupe Savings|Implemented|HTTPS|
|Include In Dwh Capacity|Implemented|HTTPS|
|Name|Implemented|HTTPS|
|Physical Disk Capacity (MB)|Implemented|HTTPS|
|Raid Group|Implemented|HTTPS|
|Raw to Usable Ratio|Implemented|HTTPS|
|Redundancy|Implemented|HTTPS|
|Reserved Capacity|Implemented|HTTPS|
|Snapshot Allocated Capacity|Gap|HTTPS|
|Snapshot Used Capacity|Implemented|HTTPS|
|Status|Implemented|HTTPS|
|Storage Pool Id|Implemented|HTTPS|
...
|Total Used Capacity|Implemented|HTTPS|
|Type|Gap|HTTPS|
|Uses FlashPools|Implemented|HTTPS|
|Virtual|Implemented|HTTPS|
||Implemented|HTTPS|
||Implemented|HTTPS|
||Implemented|HTTPS|
...
||Implemented|HTTPS|
|UUID|Implemented|HTTPS|
.13+|Storage VirtualMachine|Allocated capacity (MB)|Implemented|HTTPS|
|Comment|Implemented|HTTPS|
|Compression Savings|Implemented|HTTPS|
|Dedupe Savings|Implemented|HTTPS|
|Guid Key|Implemented|HTTPS|
|IP Space|Implemented|HTTPS|
|Internal Volume Limit|Implemented|HTTPS|
|Name|Implemented|HTTPS|
|Protocols|Implemented|HTTPS|
|State|Implemented|HTTPS|
|Type|Gap|HTTPS|
|UUID|Implemented|HTTPS|
|Used Capacity|Implemented|HTTPS|
...
.13+|Volume|Capacity|Implemented|HTTPS|
|DiskGroup|Implemented|HTTPS|
...
|Used Capacity|Implemented|HTTPS|
|Encrypted|Implemented|HTTPS|
.4+|Volume Map|LUN|Implemented|HTTPS|
...
|Storage Port|Implemented|HTTPS|
|Type|Gap|HTTPS|
.129+|performance .33+|Internal Volume|Total Capacity|Implemented|HTTPS|
|Used Capacity|Implemented|HTTPS|
|Capacity Used Ratio|Implemented|HTTPS|
...
|Optimal Utilization|Implemented|HTTPS|
|Utilization Total|Implemented|HTTPS|
.21+|StoragePool Disk|Capacity Provisioned|Implemented|HTTPS|
|Raw Capacity|Implemented|HTTPS|
...
|Throughput Total|Implemented|HTTPS|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|HTTPS|
.16+|Virtual Machine|Total Capacity|Implemented|HTTPS|
|Used Capacity|Implemented|HTTPS|
|IO Density Read|Implemented|HTTPS|
|IO Density Total|Implemented|HTTPS|
|Write IO Density|Implemented|HTTPS|
...
|Throughput Total|Implemented|HTTPS|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|HTTPS|
.19+|Volume|Raw Capacity|Implemented|HTTPS|
|Total Capacity|Implemented|HTTPS|
|Used Capacity|Implemented|HTTPS|
|Capacity Used Ratio|Implemented|HTTPS|
|IO Density Read|Implemented|HTTPS|
...
ASA-A90
ASA-C30
|NetApp Release 9.16.1P10: Thu Nov 27 17:12:10 UTC 2025
NetApp Release 9.16.1P11: Thu Jan 15 11:21:38 UTC 2026
NetApp Release 9.16.1P3: Thu Apr 24 02:50:10 UTC 2025
NetApp Release 9.16.1P6: Wed Jul 16 03:10:07 UTC 2025
NetApp Release 9.16.1P7: Thu Aug 21 10:29:10 UTC 2025
NetApp Release 9.16.1P8: Sat Oct 04 03:23:15 UTC 2025
NetApp Release 9.17.1P10: Tue Jul 21 21:51:01 UTC 2026
NetApp Release 9.17.1P1: Sat Oct 04 06:37:53 UTC 2025
NetApp Release 9.17.1P2: Fri Nov 07 09:39:01 UTC 2025
NetApp Release 9.17.1P3: Sun Dec 07 04:46:28 UTC 2025
NetApp Release 9.17.1P4: Thu Jan 15 22:33:51 UTC 2026
NetApp Release 9.17.1P5: Wed Feb 18 10:54:36 UTC 2026
NetApp Release 9.17.1P6: Wed Mar 25 15:38:10 UTC 2026
NetApp Release 9.17.1P7: Mon Apr 20 13:57:24 UTC 2026
NetApp Release 9.17.1P9: Wed Jun 24 13:09:36 UTC 2026
NetApp Release 9.18.1P3: Thu May 07 19:01:14 UTC 2026
NetApp Release 9.18.1P4: Thu Jun 04 11:38:00 UTC 2026
NetApp Release 9.18.1P5: Thu Jul 09 23:05:16 UTC 2026
...
.133+|foundation .4+|Capability|Active|Implemented|HTTPS|
|Licensed|Implemented|HTTPS|
|Type|Gap|HTTPS|
|Used|Implemented|HTTPS|
.15+|Disk|Capacity (GB)|Implemented|HTTPS|Used capacity
...
|Virtual|Implemented|HTTPS|Is this a storage virtualization device?
|UUID|Implemented|HTTPS|
.9+|Storage VirtualMachine|Allocated capacity (MB)|Implemented|HTTPS|Allocated capacity of snapshots
|Guid Key|Implemented|HTTPS|Globally Unique Key of the storage virtual machine
|IP Space|Implemented|HTTPS|
|Name|Implemented|HTTPS|
|Protocols|Implemented|HTTPS|csv of svm enabled protocols (fcp, iscsi, nfs, cifs...)
...
|Used Capacity|Implemented|HTTPS|
.1+|VirtualMachine Volume Ref|Volume Name|Implemented|HTTPS|
.17+|Volume|Capacity|Implemented|HTTPS|Snapshot Used capacity in MB
...
|Storage Port|Implemented|HTTPS|
|Type|Gap|HTTPS|
.94+|performance .11+|Disk|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
|Key|Implemented|HTTPS|
|Server ID|Implemented|HTTPS|
...
|Throughput Total|Implemented|HTTPS|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|HTTPS|
.18+|Storage Node|Cache Hit Ratio Total|Implemented|HTTPS|
|Total Disk Read Replaced|Implemented|HTTPS|
|Failed Disks|Implemented|HTTPS|
|Failed Fans|Implemented|HTTPS|
|Failed Power Units|Implemented|HTTPS|
...
|205.5
Brocade 300E
Brocade 32Gb Fibre Channel SAN Switch Module for HPE Synergy
...
.68+|foundation .4+|FC Name Server Entry|FC ID|Implemented|SSH|
...
|WWN|Implemented|SSH|
.30+|performance .30+|port|BB Credit Zero Received|Implemented|SNMP|BB Credit Zero Received
...
|v10.0.0a
v10.0.0a1
v10.0.0a1_cvr_881241_01
v10.0.0a_cvr_875417_01
v8.2.2d
v8.2.3
v8.2.3b
v8.2.3c
...
.69+|foundation .4+|FC Name Server Entry|FC ID|Implemented|HTTPS|
...
|WWN|Implemented|HTTPS|
.29+|performance .29+|port|BB Credit Zero Received|Implemented|HTTPS|BB Credit Zero Received
...
|WWN|Implemented|SNMP|
.28+|performance .28+|port|BB Credit Zero Received|Implemented|SNMP|BB Credit Zero Received
|BB Credit Zero Total|Implemented|SNMP|BB Credit Zero Total
|BB Credit Zero Transmitted|Implemented|SNMP|BB Credit Zero Transmitted
|BB Credit Zero Ms Transmitted|Implemented|SNMP|BB Credit Zero Ms Transmitted
|Key|Implemented|SNMP|
...
7.1.2_u4_release-20250529_205b971c
7.3.2_release-20260123_529553a9
...
.56+|performance .9+|Disk|IOPs Read|Implemented||Number of read IOPs on the disk
...
.5+|Internal Volume|Total Capacity|Implemented||
...
|Throughput Write|Implemented||
|Utilization Total|Implemented||
.12+|Storage Node|IOPs Read|Implemented||Number of read IOPs on the disk
|IOPs Total|Implemented||
|IOPs Write|Implemented||
|Key|Implemented||
|Latency Read|Implemented||
...
|Throughput Write|Implemented||
|Utilization Total|Implemented||
.12+|StoragePool Disk|Capacity Provisioned|Implemented||
|Raw Capacity|Implemented||
...
|Type|Gap|HTTPS|
|Virtual|Implemented|HTTPS|Is this a storage virtualization device?
.81+|performance .8+|Disk|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
|Key|Implemented|HTTPS|
|Server ID|Implemented|HTTPS|
...
|Throughput Total|Implemented|HTTPS|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|HTTPS|
.18+|Internal Volume|Total Capacity|Implemented|HTTPS|
|Used Capacity|Implemented|HTTPS|
|Capacity Used Ratio|Implemented|HTTPS|
|Total Compression Savings|Implemented|HTTPS|
|Compression Savings Space|Implemented|HTTPS|
...
|Throughput Total|Implemented|HTTPS|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|HTTPS|
.15+|Storage Node|Failed Disks|Implemented|HTTPS|
...
.104+|foundation .16+|Disk|Capacity (GB)|Implemented|SSH|Used capacity
...
|Type|Gap|SSH|
|Virtual|Implemented|SSH|Is this a storage virtualization device?
.54+|performance .8+|Internal Volume|Total Capacity|Implemented|SSH|
...
.7+|Qtree|Quota Hard Limit|Implemented|SSH|Capacity quota hard limit
...
.14+|Storage Node|IOPs Read|Implemented|SSH|Number of read IOPs on file system
...
5978.714.714 build 145 build 145
5978.714.714 build 147 build 147
5978.714.714 build 149 build 149
5978.714.714 build 184
5978.714.714 build 184 build 184
5978.714.714 build 185 build 185
5978.714.714 build 236
5978.714.714 build 252
5978.714.714 build 252 build 252
5978.714.714 build 49
5978.714.714 build 49 build 49
5978.714.714 build 79 build 79
5978.720.720 build 1
5978.720.720 build 17
5978.720.720 build 27
5978.720.720 build 27 build 27
5978.720.720 build 32 build 32
5978.720.720 build 33
5978.720.720 build 33 build 33
5978.720.720 build 38 build 38
5978.720.720 build 56
5978.720.720 build 56 build 56
5978.720.720 build 6
5978.720.720 build 77 build 77
6079.225.0 build 216 build 216
6079.275.0 build 221 build 221
6079.275.0 build 250 build 250
6079.275.0 build 292 build 292
6079.275.0 build 396 build 396
6079.280.0 build 37 build 37
6079.280.0 build 53 build 53
6079.325.0 build 216 build 216
6079.325.0 build 231 build 231
6079.325.0 build 244 build 244
6079.325.0 build 253 build 253
6079.325.0 build 275 build 275
6079.325.0 build 84 build 84
...
.91+|foundation .10+|Disk|Capacity (GB)|Implemented|HTTPS|
|Disk Id|Implemented|HTTPS|
|Model|Implemented|HTTPS|
|Name|Implemented|HTTPS|
|Role|Implemented|HTTPS|
|Role Enum|Implemented|HTTPS|
|Status|Implemented|HTTPS|
|Status Enum|Implemented|HTTPS|
|Type Enum|Implemented|HTTPS|
|Vendor|Implemented|HTTPS|
...
|UUID|Implemented|HTTPS|
.14+|Storage Pool|Include In Dwh Capacity|Implemented|HTTPS|
|Name|Implemented|HTTPS|
|Physical Disk Capacity (MB)|Implemented|HTTPS|
|Raid Group|Implemented|HTTPS|
|Raw to Usable Ratio|Implemented|HTTPS|
...
|Technology|Implemented|HTTPS|
.21+|Volume|AutoTier Policy Identifier|Implemented|HTTPS|
|Auto Tiering|Implemented|HTTPS|
|Capacity|Implemented|HTTPS|
|Disk Type|Not Available|HTTPS|
|Junction Path|Implemented|HTTPS|
|Name|Implemented|HTTPS|
|Total Raw Capacity|Implemented|HTTPS|
...
|Source|Implemented|HTTPS|
|WWN|Implemented|HTTPS|
.78+|performance .9+|Disk|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
|Key|Implemented|HTTPS|
|Server ID|Implemented|HTTPS|
...
.12+|Storage Node|Cache Hit Ratio Total|Implemented|HTTPS|
|Total Disk Read Replaced|Implemented|HTTPS|
|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
...
|Quota UsedCapacity|Implemented|SSH|Space in MB currently used
|Type|Gap|SSH|
.11+|Quota|GuidKey 1|Implemented|SSH|GuidKey1 is implicit for all objects whose GUID key has not changed since OCI version 7.3.5.
|GuidKey 2|Implemented|SSH|GuidKey2 is implicit for all objects whose GUID key has not changed since OCI version 7.3.5.
...
|WWN|Implemented|CLI|
.76+|performance .11+|Disk|IOPs Read|Implemented|CLI|Number of read IOPs on the disk
...
.20+|Storage|Cache Hit Ratio Read|Implemented|CLI|
...
|Throughput Total|Implemented|CLI|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|CLI|
.6+|Storage Node|IOPs Read|Implemented|CLI|Number of read IOPs on the disk
|IOPs Total|Implemented|CLI|
|IOPs Write|Implemented|CLI|
|Key|Implemented|CLI|
|Server ID|Implemented|CLI|
...
|Utilization Total|Implemented|CLI|
|Utilization Write|Implemented|CLI|
.19+|Volume|Cache Hit Ratio Read|Implemented|CLI|
|Cache Hit Ratio Total|Implemented|CLI|
|Cache Hit Ratio Write|Implemented|CLI|
|Raw Capacity|Implemented|CLI|
|Total Capacity|Implemented|CLI|
...
.95+|foundation .14+|Disk|Capacity (GB)|Implemented|SSH|Used capacity
|Disk Id|Implemented|SSH|Uniquely identifies this disk in the array
|Group|Implemented|SSH|
|Location|Gap|SSH|Where this disk is physically located in the array
|Model|Implemented|SSH|
...
|Date|Implemented|SSH|
|Originator ID|Implemented|SSH|
.17+|Internal Volume|Data Allocated Capacity|Gap|SSH|capacity allocated for data
|Data Used Capacity|Implemented|SSH|
|Dedupe Enabled|Implemented|SSH|Is dedupe enabled on the storage pool
|Dedupe Savings|Implemented|SSH|ratio of dedupe savings in percentage
|Internal Volume Id|Implemented|SSH|
...
|Type|Gap|HTTPS|
|Virtual|Implemented|HTTPS|Is this a storage virtualization device?
.33+|performance .6+|Internal Volume|Total Capacity|Implemented|HTTPS|
|Used Capacity|Implemented|HTTPS|
|Capacity Used Ratio|Implemented|HTTPS|
|Key|Implemented|HTTPS|
|Total Objects|Implemented|HTTPS|
...
.2+|Qtree|Key|Implemented|HTTPS|
|Server ID|Implemented|HTTPS|
.10+|Storage|Failed Raw Capacity|Implemented|HTTPS|
|Raw Capacity|Implemented|HTTPS|
|Spare Raw Capacity|Implemented|HTTPS|Raw capacity of spare disks (sum of all disks that are spare)
|StoragePools Capacity|Implemented|HTTPS|
|IOPs Total|Implemented|HTTPS|
...
|Throughput Total|Implemented|HTTPS|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|HTTPS|
.9+|Storage Node|IOPs Total|Implemented|HTTPS|
|Key|Implemented|HTTPS|
...
|Source|Implemented||
|WWN|Implemented||
.63+|performance .5+|Internal Volume|Total Capacity|Implemented||
|Used Capacity|Implemented||
|Capacity Used Ratio|Implemented||
|Key|Implemented||
|Server ID|Implemented||
...
5978.714.714(175A0000) build 147
5978.714.714(175A0000) build 149
5978.714.714(175A0000) build 184
5978.714.714(175A0000) build 185
5978.714.714(175A0000) build 236
5978.714.714(175A0000) build 252
5978.714.714(175A0000) build 49
5978.714.714(175A0000) build 53
5978.720.720(175A0000) build 1
5978.720.720(175A0000) build 27
5978.720.720(175A0000) build 38
5978.720.720(175A0000) build 56
5978.720.720(175A0000) build 6
...
.144+|foundation .3+|Device Group|Name|Implemented||
...
|Source|Implemented||
|WWN|Implemented||
.75+|performance .8+|Disk|IOPs Read|Implemented||Number of read IOPs on the disk
|IOPs Total|Implemented||
|IOPs Write|Implemented||
|Key|Implemented||
|Server ID|Implemented||
...
.10+|Storage Node|Cache Hit Ratio Total|Implemented||
|IOPs Read|Implemented||Number of read IOPs on the disk
|IOPs Total|Implemented||
|IOPs Write|Implemented||
|Key|Implemented||
...
|Throughput Write|Implemented||
|Utilization Total|Implemented||
.18+|StoragePool Disk|Capacity Provisioned|Implemented||
|Raw Capacity|Implemented||
...
.148+|foundation .14+|Disk|Capacity (GB)|Implemented|SSH|Used capacity
|Disk Id|Implemented|SSH|Uniquely identifies this disk in the array
|Group|Implemented|SSH|
|Location|Gap|SSH|Where this disk is physically located in the array
|Model|Implemented|SSH|
...
|UUID|Implemented|SSH|
|ManagementIp Addresses|Implemented|SSH|
.20+|Storage Pool|Data Allocated Capacity|Gap|SSH|capacity allocated for data
|Data Used Capacity|Implemented|SSH|
|Dedupe Enabled|Implemented|SSH|Is dedupe enabled on the storage pool
|Include In Dwh Capacity|Implemented|SSH|A way from ACQ to control which storage pools are interesting in DWH Capacity
|Name|Implemented|SSH|
...
|Type|Gap|SSH|
|Virtual|Implemented|SSH|Is this a storage virtualization device?
.15+|Volume|AutoTier Policy Identifier|Implemented|SSH|Dynamic Tier Policy identifier
...
|Storage Port|Implemented|SSH|
|Type|Gap|SSH|
.7+|Volume Member|Capacity|Implemented|SSH|Snapshot Used capacity in MB
|Name|Implemented|SSH|
...
|Source|Implemented|SSH|
|WWN|Implemented|SSH|
.76+|performance .11+|Disk|IOPs Read|Implemented|SSH|Number of read IOPs on the disk
|IOPs Total|Implemented|SSH|
|IOPs Write|Implemented|SSH|
|Key|Implemented|SSH|
|Server ID|Implemented|SSH|
...
.20+|Storage|Cache Hit Ratio Read|Implemented|SSH|
...
|Throughput Total|Implemented|SSH|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|SSH|
.6+|Storage Node|IOPs Read|Implemented|SSH|Number of read IOPs on the disk
|IOPs Total|Implemented|SSH|
|IOPs Write|Implemented|SSH|
|Key|Implemented|SSH|
|Server ID|Implemented|SSH|
|Utilization Total|Implemented|SSH|
.20+|StoragePool Disk|Capacity Provisioned|Implemented|SSH|
|Raw Capacity|Implemented|SSH|
|Total Capacity|Implemented|SSH|
|Used Capacity|Implemented|SSH|
|Over Commit Capacity Ratio|Implemented|SSH|Reported as a time series
...
|Utilization Total|Implemented|SSH|
|Utilization Write|Implemented|SSH|
.19+|Volume|Cache Hit Ratio Read|Implemented|SSH|
|Cache Hit Ratio Total|Implemented|SSH|
|Cache Hit Ratio Write|Implemented|SSH|
|Raw Capacity|Implemented|SSH|
|Total Capacity|Implemented|SSH|
...
.121+|foundation .15+|Disk|Capacity (GB)|Implemented|HTTPS|Used capacity
|Disk Id|Implemented|HTTPS|Uniquely identifies this disk in the array
|Group|Implemented|HTTPS|
|Location|Gap|HTTPS|Where this disk is physically located in the array
|Model|Implemented|HTTPS|
...
|Storage Port|Implemented|HTTPS|
|Type|Gap|HTTPS|
.57+|performance .8+|Disk|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
|Key|Implemented|HTTPS|
|Server ID|Implemented|HTTPS|
...
|Throughput Total|Implemented|HTTPS|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|HTTPS|
.9+|Internal Volume|Total Capacity|Implemented|HTTPS|
|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
|Key|Implemented|HTTPS|
...
|Key|Implemented|HTTPS|
|Server ID|Implemented|HTTPS|
.6+|Storage Node|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
|Key|Implemented|HTTPS|
|Server ID|Implemented|HTTPS|
...
|Throughput Total|Implemented|HTTPS|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|HTTPS|
.13+|Volume|Raw Capacity|Implemented|HTTPS|
|Total Capacity|Implemented|HTTPS|
|Used Capacity|Implemented|HTTPS|
|Capacity Used Ratio|Implemented|HTTPS|
|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
...
.64+|foundation .4+|Info|DataSource Name|Implemented|HTTP/S|Info
...
.7+|Storage Node|Model|Implemented|HTTP/S|
|Name|Implemented|HTTP/S|
|Serial Number|Implemented|HTTP/S|
...
|Parent Serial Number|Implemented|HTTP/S|
...
|Storage Port|Implemented|HTTP/S|
|Type|Gap|HTTP/S|
.45+|performance .13+|Storage|Failed Raw Capacity|Implemented|SSH|
|Raw Capacity|Implemented|SSH|
|Spare Raw Capacity|Implemented|SSH|Raw capacity of spare disks (sum of all disks that are spare)
|StoragePools Capacity|Implemented|SSH|
|IOPs Total|Implemented|SSH|
...
|Throughput Write|Implemented|SSH|
|Utilization Total|Implemented|SSH|
.8+|StoragePool Disk|Capacity Provisioned|Implemented|SSH|
|Raw Capacity|Implemented|SSH|
|Total Capacity|Implemented|SSH|
|Used Capacity|Implemented|SSH|
|Over Commit Capacity Ratio|Implemented|SSH|Reported as a time series
...
|Protocol Controller|Implemented|HTTPS|
|Type|Gap|HTTPS|
.51+|performance .16+|Storage|Failed Raw Capacity|Implemented|HTTPS|
|Raw Capacity|Implemented|HTTPS|
|Spare Raw Capacity|Implemented|HTTPS|Raw capacity of spare disks (sum of all disks that are spare)
|StoragePools Capacity|Implemented|HTTPS|
|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
...
|Throughput Total|Implemented|HTTPS|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|HTTPS|
.11+|Storage Node|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
|Key|Implemented|HTTPS|
|Latency Read|Implemented|HTTPS|
...
|Originator ID|Implemented|HTTPS|
|Originator Key|Implemented|HTTPS|
.26+|performance .8+|Virtual Disk|Total Capacity|Implemented|HTTPS|
|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
|Latency Total|Implemented|HTTPS|
...
|Throughput Total|Implemented|HTTPS|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|HTTPS|
.18+|vm|Total Capacity|Implemented|HTTPS|
|Capacity Used Ratio|Implemented|HTTPS|
|Total CPU Utilization|Implemented|HTTPS|
|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|diskIops.total|Implemented|HTTPS|
...
.72+|foundation .7+|File Share|Is InternalVolume|Implemented|HTTPS|whether the file share represents an internal volume (netapp volume) or is it a qtree/folder within the internal volume
|Is Shared|Implemented|HTTPS|whether this fileShare has any shares associated with it
|Name|Implemented|HTTPS|
|Path|Implemented|HTTPS|Path of the fileShare
|Qtree Id|Implemented|HTTPS|unique id of the qtree
...
|Date|Implemented|HTTPS|
|Originator ID|Implemented|HTTPS|
.23+|Internal Volume|Compression Enabled|Implemented|HTTPS|Is compression enabled on the storage pool
|Data Allocated Capacity|Gap|HTTPS|capacity allocated for data
|Data Used Capacity|Implemented|HTTPS|
|Dedupe Enabled|Implemented|HTTPS|Is dedupe enabled on the storage pool
|Internal Volume Id|Implemented|HTTPS|
...
|Qos Limit Raw|Implemented|HTTPS|
|QoS - Policy|Implemented|HTTPS|
.5+|QTree|Name|Implemented|HTTPS|
|Qtree Id|Implemented|HTTPS|unique id of the qtree
|Security Style|Implemented|HTTPS|Security style of the directory: unix, ntfs, or mixed
|Status|Implemented|HTTPS|
|Type|Gap|HTTPS|
...
|Virtual|Implemented|HTTPS|Is this a storage virtualization device?
||Implemented|HTTPS|
.54+|performance .21+|Internal Volume|Total Capacity|Implemented|HTTPS|
|Used Capacity|Implemented|HTTPS|
|Capacity Used Ratio|Implemented|HTTPS|
|Total Data Capacity|Implemented|HTTPS|
|Data Used Capacity|Implemented|HTTPS|
...
|Throughput Total|Implemented|HTTPS|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|HTTPS|
.17+|StoragePool Disk|Capacity Provisioned|Implemented|HTTPS|
|Raw Capacity|Implemented|HTTPS|
|Total Capacity|Implemented|HTTPS|
|Used Capacity|Implemented|HTTPS|
|Over Commit Capacity Ratio|Implemented|HTTPS|Reported as a time series
...
|Type|Gap|HTTPS|
|Virtual|Implemented|HTTPS|Is this a storage virtualization device?
.30+|performance .6+|Internal Volume|Total Capacity|Implemented||
|Used Capacity|Implemented||
|Capacity Used Ratio|Implemented||
|Key|Implemented||
...
.2+|Qtree|Key|Implemented||
|Server ID|Implemented||
.9+|Storage|Failed Raw Capacity|Implemented||
|Raw Capacity|Implemented||
|Spare Raw Capacity|Implemented||Raw capacity of spare disks (sum of all disks that are spare)
|StoragePools Capacity|Implemented||
|Key|Implemented||
...
|Throughput Total|Implemented||Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented||
.6+|Storage Node|Key|Implemented||
|Server ID|Implemented||
|Throughput Read|Implemented||
|Throughput Total|Implemented||Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented||
|Utilization Total|Implemented||
.7+|StoragePool Disk|Capacity Provisioned|Implemented||
|Raw Capacity|Implemented||
|Capacity Soft Limit|Implemented||
|Total Capacity|Implemented||
|Used Capacity|Implemented||
...
.90+|foundation .13+|Disk|Capacity (GB)|Implemented|HDS XML API|Used capacity
...
|Type|Gap|HDS XML API|
|Virtual|Implemented|HDS XML API|Is this a storage virtualization device?
.7+|Storage Synchronization|Mode|Implemented|HDS XML API|
...
.64+|performance .9+|Disk|IOPs Read|Implemented|Export/CLI|Number of read IOPs on the disk
...
|Throughput Total|Implemented|Export/CLI|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|Export/CLI|
.5+|Storage Node|IOPs Total|Implemented|Export/CLI|
|Key|Implemented|Export/CLI|
|Latency Total|Implemented|Export/CLI|
|Server ID|Implemented|Export/CLI|
|Throughput Total|Implemented|Export/CLI|Average disk total rate (read and write across all disks) in MB/s
.13+|StoragePool Disk|Capacity Provisioned|Implemented|Export/CLI|
|Raw Capacity|Implemented|Export/CLI|
...
|Throughput Write|Implemented|Export/CLI|
|Utilization Total|Implemented|Export/CLI|
.18+|Volume|Cache Hit Ratio Read|Implemented|Export/CLI|
|Cache Hit Ratio Total|Implemented|Export/CLI|
|Cache Hit Ratio Write|Implemented|Export/CLI|
|Raw Capacity|Implemented|Export/CLI|
|Total Capacity|Implemented|Export/CLI|
...
VSP One B28
XP8
|80-06-86-00/00:01-76-03/03
80-06-96-00/00:01-76-03/03
83-05-51-60/00:01-76-03/03
88-08-10-60/00:01-76-03/03
88-08-12-60/00:01-57-03/00
88-08-12-60/00:01-76-03/03
88-08-13-60/01:01-76-03/03
88-08-15-21/00:01-76-03/03
88-08-16-21/10:01-76-03/03
88-08-19-60/00:01-76-03/03
88-08-20-60/00:01-76-03/03
90-09-24-00/01:01-76-03/03
90-09-24:01.65.05
90-09-24:01.72.00
90-09-26-00/00:01-76-03/03
90-09-27-00/01:01-76-03/03
90-09-28-00/00:01-65-03/05
90-09-28-00/00:01-76-03/03
90-09-30-00/00:01-65-03/05
90-09-30-00/00:01-76-03/03
90-09-30-00/00:01-87-03/03
90-09-30-00/00:01-88-03/03
90-09-31-00/20:01-76-03/03
90-09-31-00/20:01-88-03/03
93-07-22-40/00:01-76-03/03
93-07-25-40/00:01-76-03/03
93-07-29-40/00:01-76-03/03
93-07-29-80/00:01-65-03/05
93-07-29-80/00:01-76-03/03
93-07-29-80/00:01-87-03/03
A3-04-21-40/00:01-88-03/03
A3-04-22-40/00:01-76-03/03
A3-04-22-40/00:01-88-03/03
A3-04-23-40/01:01-88-03/03
null:null
...
.103+|foundation .15+|Disk|Capacity (GB)|Implemented||
|Disk Id|Implemented||
|Group|Implemented||
|Location|Gap||
|Model|Implemented||
...
|Vendor|Implemented||
.10+|Disk Group|Capacity|Implemented||
|DiskGroup Id|Implemented||
|Disk Type|Not Available||
|Name|Implemented||
|Physical Disk Capacity (MB)|Implemented||
|Redundancy|Implemented||
|Status|Implemented||
|Used Capacity|Implemented||
|Vendor DiskGroup Type|Implemented||
|Virtual|Implemented||
.4+|ISCSI Network Portal|IP|Implemented||
|Listening Port|Implemented||
|Nic|Implemented||
...
.2+|ISCSI Node Map|OID|Implemented||
|Portal Group OID|Implemented||
.4+|Info|DataSource Name|Implemented||
|Date|Implemented||
|Originator ID|Implemented||
|Originator Key|Implemented||
.14+|Storage|Display IP|Implemented||
...
|Model|Implemented||
|Name|Implemented||
|Total Raw Capacity|Implemented||
|Serial Number|Implemented||
|Spare Raw Capacity|Implemented||
|SupportActive Active|Implemented||
|Virtual|Implemented||
.2+|Storage Node|Name|Implemented||
|UUID|Implemented||
.18+|Storage Pool|Compression Enabled|Implemented||
|Compression Savings|Implemented||
|Dedupe Enabled|Implemented||
|Include In Dwh Capacity|Implemented||
|Name|Implemented||
|Physical Disk Capacity (MB)|Implemented||
|Raid Group|Implemented||
|Raw to Usable Ratio|Implemented||
|Redundancy|Implemented||
|Soft Limit (MB)|Implemented||
|Status|Implemented||
|Storage Pool Id|Implemented||
|Thin Provisioning Supported|Implemented||
|Total Allocated Capacity|Implemented||
|Total Used Capacity|Implemented||
|Type|Gap||
|Virtual|Implemented||
|Encrypted|Implemented||
.9+|Storage Synchronization|Mode|Implemented||
...
.10+|Volume|Capacity|Implemented||
|Junction Path|Implemented||
|Name|Implemented||
...
|Storage Port|Implemented||
|Type|Gap||
.62+|performance .8+|Disk|IOPs Read|Implemented||Number of read IOPs on the disk
|IOPs Total|Implemented||
|IOPs Write|Implemented||
|Key|Implemented||
|Server ID|Implemented||
...
|Throughput Total|Implemented||Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented||
.4+|Storage Node|IOPs Total|Implemented||
|Key|Implemented||
|Server ID|Implemented||
|Throughput Total|Implemented||Average disk total rate (read and write across all disks) in MB/s
...
|Throughput Write|Implemented||
|Utilization Total|Implemented||
.18+|Volume|Cache Hit Ratio Read|Implemented||
|Cache Hit Ratio Total|Implemented||
|Cache Hit Ratio Write|Implemented||
|Raw Capacity|Implemented||
|Total Capacity|Implemented||
...
InServ T400
InServ V400
|10.4.20 Release Type: Standard Support Release
10.5.50 Release Type: Standard Support Release
10.5.55 Release Type: Standard Support Release
10.5.64 Release Type: Limited Availability Release
3.1.2 (MU3) P16
3.1.3 (MU1) P07
3.2.1 (MU3) P17
3.2.2 (MU4) P51
...
4.5.8 Release Type: Extended Support Release
4.6.1 Release Type: Extended Support Release
4.6.20 Release Type: Extended Support Release
4.6.21 Release Type: Limited Availability Release
4.6.5 Release Type: Extended Support Release
9.6.20 Release Type: Extended Support Release
P09
P10
P102
P103
...
.121+|foundation .3+|Device Group|Name|Implemented|SSH|
...
|OID|Implemented|SSH|
|Type|Gap|SSH|
.8+|ISCSI Session|Initiator Ips|Implemented|SSH|
...
|Source|Implemented|SSH|
|WWN|Implemented|SSH|
.84+|performance .8+|Disk|IOPs Read|Implemented|SMI-S|Number of read IOPs on the disk
...
.21+|Storage|Cache Hit Ratio Read|Implemented|SMI-S|
...
.13+|Storage Node|Cache Hit Ratio Total|Implemented|SMI-S|
|IOPs Read|Implemented|SMI-S|Number of read IOPs on the disk
|IOPs Total|Implemented|SMI-S|
|IOPs Write|Implemented|SMI-S|
|Key|Implemented|SMI-S|
...
6.1.2.700-1069734-opt
6.1.2.800-1084673-opt
6.1.3.300-1084694-opt
...
.113+|foundation .17+|Disk|Capacity (GB)|Implemented|HTTPS|Used capacity
|Disk Id|Implemented|HTTPS|Uniquely identifies this disk in the array
|Group|Implemented|HTTPS|
|Location|Gap|HTTPS|Where this disk is physically located in the array
|Model|Implemented|HTTPS|
...
|Source|Implemented|HTTPS|
|WWN|Implemented|HTTPS|
.47+|performance .16+|Storage|Failed Raw Capacity|Implemented|HTTPS|
|Raw Capacity|Implemented|HTTPS|
|Spare Raw Capacity|Implemented|HTTPS|Raw capacity of spare disks (sum of all disks that are spare)
|StoragePools Capacity|Implemented|HTTPS|
|IOPs other|Implemented|HTTPS|
...
|Originator ID|Implemented|HTTPS|
|Originator Key|Implemented|HTTPS|
.13+|Internal Volume|Data Used Capacity|Implemented|HTTPS|
|Dedupe Enabled|Implemented|HTTPS|Is dedupe enabled on the storage pool
|Dedupe Savings|Implemented|HTTPS|ratio of dedupe savings in percentage
|Internal Volume Id|Implemented|HTTPS|
|Name|Implemented|HTTPS|
...
|Total Used Capacity|Implemented|HTTPS|Total capacity in MB
|Type|Gap|HTTPS|
.7+|QTree|Name|Implemented|HTTPS|
|Qtree Id|Implemented|HTTPS|unique id of the qtree
|Quota HardCapacity Limit (MB)|Implemented|HTTPS|Maximum amount of disk space, allowed for the quota target
|Quota SoftCapacity Limit (MB)|Implemented|HTTPS|Maximum amount of disk space, allowed for the quota target
|Quota UsedCapacity|Implemented|HTTPS|Space in MB currently used
...
|Storage Port|Implemented|HTTPS|
|Type|Gap|HTTPS|
.82+|performance .9+|Disk|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
|Key|Implemented|HTTPS|
|Server ID|Implemented|HTTPS|
...
|Throughput Write|Implemented|HTTPS|
|Utilization Total|Implemented|HTTPS|
.15+|Internal Volume|Total Capacity|Implemented|HTTPS|
|Data Used Capacity|Implemented|HTTPS|
|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
...
|Throughput Total|Implemented|HTTPS|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|HTTPS|
.12+|Storage Node|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
|Key|Implemented|HTTPS|
|Latency Read|Implemented|HTTPS|
...
.65+|performance .11+|Disk|IOPs Read|Implemented|DSNI|Number of read IOPs on the disk
...
.19+|Storage|Cache Hit Ratio Read|Implemented|DSNI|
...
|Source|Implemented|SSH|
|WWN|Implemented|SSH|
.78+|performance .11+|Disk|IOPs Read|Implemented|SSH|Number of read IOPs on the disk
|IOPs Total|Implemented|SSH|
|IOPs Write|Implemented|SSH|
|Key|Implemented|SSH|
|Server ID|Implemented|SSH|
...
|Utilization Total|Implemented|SSH|
|Utilization Write|Implemented|SSH|
.19+|Storage|Cache Hit Ratio Read|Implemented|SSH|
|Cache Hit Ratio Total|Implemented|SSH|
|Cache Hit Ratio Write|Implemented|SSH|
|Failed Raw Capacity|Implemented|SSH|
|Raw Capacity|Implemented|SSH|
...
|Utilization Total|Implemented|SSH|
|Utilization Write|Implemented|SSH|
.20+|Volume|Cache Hit Ratio Read|Implemented|SSH|
|Cache Hit Ratio Total|Implemented|SSH|
|Cache Hit Ratio Write|Implemented|SSH|
|Raw Capacity|Implemented|SSH|
|Total Capacity|Implemented|SSH|
...
.68+|foundation .12+|Disk|Capacity (GB)|Implemented|XIV CLI|Used capacity
...
.18+|Storage Pool|Data Allocated Capacity|Gap|XIV CLI|capacity allocated for data
...
|Type|Gap|XIV CLI|
|Virtual|Implemented|XIV CLI|Is this a storage virtualization device?
.11+|Volume|Capacity|Implemented|XIV CLI|Snapshot Used capacity in MB
...
|Originator ID|Implemented|HTTPS|
|Originator Key|Implemented|HTTPS|
.22+|performance .9+|Virtual Disk|Total Capacity|Implemented|HTTPS|
|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
|Key|Implemented|HTTPS|
...
|Throughput Total|Implemented|HTTPS|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|HTTPS|
.13+|vm|Total Capacity|Implemented|HTTPS|
|Total CPU Utilization|Implemented|HTTPS|
|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|diskIops.total|Implemented|HTTPS|
|Disk IOPs write|Implemented|HTTPS|
...
|Virtual|Implemented|HTTPS|Is this a storage virtualization device?
|Comment|Gap|HTTPS|state: free text comment describing the svm
.41+|performance .17+|Internal Volume|Total Capacity|Implemented||
|Used Capacity|Implemented||
|Capacity Used Ratio|Implemented||
|Total Data Capacity|Implemented||
|Data Used Capacity|Implemented||
...
|Throughput Total|Implemented||Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented||
.4+|Qtree|Quota Hard Limit|Implemented||Capacity quota hard limit
...
.44+|performance .16+|Host|Total CPU Utilization|Implemented|WS-Management|
...
.12+|Virtual Disk|Total Capacity|Implemented|WS-Management|
...
.16+|vm|Total Capacity|Implemented|WS-Management|
|Used Capacity|Implemented|WS-Management|
|Capacity Used Ratio|Implemented|WS-Management|
...
.178+|foundation .4+|Capability|Active|Implemented||
...
|Status|Implemented||
|Type|Gap||
.11+|Quota|Hard Capacity Limit (MB)|Implemented||max amount of disk space, allowed for the quota target (Hard limit)
...
|Storage Port|Implemented||
|Type|Gap||
.116+|performance .11+|Disk|IOPs Read|Implemented||Number of read IOPs on the disk
|IOPs Total|Implemented||
|IOPs Write|Implemented||
|Key|Implemented||
|Server ID|Implemented||
...
.25+|Internal Volume|Total Capacity|Implemented||
|Used Capacity|Implemented||
|Capacity Used Ratio|Implemented||
|Total Compression Savings|Implemented||
|Compression Savings Space|Implemented||
|Total Data Capacity|Implemented||
|Data Used Capacity|Implemented||
...
|Throughput Total|Implemented||Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented||
.7+|Qtree|Quota Hard Limit|Implemented||Capacity quota hard limit
...
|Key|Implemented||
|Server ID|Implemented||
.19+|Storage|Failed Raw Capacity|Implemented||
|Raw Capacity|Implemented||
|Spare Raw Capacity|Implemented||Raw capacity of spare disks (sum of all disks that are spare)
|StoragePools Capacity|Implemented||
|IO Density Read|Implemented||
...
|Throughput Total|Implemented||Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented||
.14+|Storage Node|Cache Hit Ratio Total|Implemented||
...
|Utilization Total|Implemented||
|Utilization Write|Implemented||
.20+|Volume|Raw Capacity|Implemented||
|Total Capacity|Implemented||
|Used Capacity|Implemented||
|Capacity Used Ratio|Implemented||
|IO Density Read|Implemented||
...
|Storage Port|Implemented|HTTPS|
|Type|Gap|HTTPS|
.157+|performance .11+|Disk|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
|Key|Implemented|HTTPS|
|Server ID|Implemented|HTTPS|
...
|Storage Port|Implemented|RMI|
|Type|Gap|RMI|
.81+|performance .11+|Disk|IOPs Read|Implemented|RMI|Number of read IOPs on the disk
...
.19+|Storage|Cache Hit Ratio Read|Implemented|RMI|
...
|Throughput Total|Implemented|RMI|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|RMI|
.12+|Storage Node|Cache Hit Ratio Total|Implemented|RMI|
|IOPs Read|Implemented|RMI|Number of read IOPs on the disk
|IOPs Total|Implemented|RMI|
|IOPs Write|Implemented|RMI|
|Key|Implemented|RMI|
...
|Utilization Total|Implemented|RMI|
|Utilization Write|Implemented|RMI|
.20+|Volume|Cache Hit Ratio Read|Implemented|RMI|
|Cache Hit Ratio Total|Implemented|RMI|
|Cache Hit Ratio Write|Implemented|RMI|
|Raw Capacity|Implemented|RMI|
|Total Capacity|Implemented|RMI|
...
|Storage Port|Implemented|HTTPS|
|Type|Gap|HTTPS|
.80+|performance .11+|Disk|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
|Key|Implemented|HTTPS|
|Server ID|Implemented|HTTPS|
...
|Utilization Total|Implemented|HTTPS|
|Utilization Write|Implemented|HTTPS|
.19+|Storage|Cache Hit Ratio Read|Implemented|HTTPS|
|Cache Hit Ratio Total|Implemented|HTTPS|
|Cache Hit Ratio Write|Implemented|HTTPS|
|Failed Raw Capacity|Implemented|HTTPS|
|Raw Capacity|Implemented|HTTPS|
...
.42+|foundation .6+|LUN|Disk Name|Implemented|Web Services|
...
NetApp Release 9.14.1P14: Sun Aug 24 04:57:05 UTC 2025
NetApp Release 9.14.1P1: Thu Feb 15 00:45:21 UTC 2024
NetApp Release 9.14.1P6: Tue Jun 18 16:11:44 UTC 2024
NetApp Release 9.15.1: Thu Jul 04 07:17:54 UTC 2024
NetApp Release 9.15.1P10: Thu Apr 17 14:04:43 UTC 2025
NetApp Release 9.15.1P11: Wed May 21 22:53:05 UTC 2025
NetApp Release 9.15.1P13: Tue Jul 15 14:07:45 UTC 2025
NetApp Release 9.15.1P14: Tue Aug 05 15:53:54 UTC 2025
NetApp Release 9.15.1P15: Sun Oct 05 06:25:31 UTC 2025
NetApp Release 9.15.1P16: Sat Nov 29 23:46:11 UTC 2025
NetApp Release 9.15.1P17: Tue Feb 10 12:35:50 UTC 2026
NetApp Release 9.15.1P19: Sat May 09 17:13:04 UTC 2026
...
NetApp Release 9.15.1P8: Fri Mar 07 22:41:00 UTC 2025
NetApp Release 9.16.1: Sat Jan 18 19:31:15 UTC 2025
NetApp Release 9.16.1P10: Thu Nov 27 17:12:10 UTC 2025
NetApp Release 9.16.1P11: Thu Jan 15 11:21:38 UTC 2026
NetApp Release 9.16.1P12: Wed Mar 11 12:37:44 UTC 2026
NetApp Release 9.16.1P12D1: Fri May 15 20:58:40 UTC 2026
NetApp Release 9.16.1P13: Fri May 08 03:41:42 UTC 2026
NetApp Release 9.16.1P14: Thu Jul 09 16:46:59 UTC 2026
NetApp Release 9.16.1P2: Wed Mar 19 10:28:11 UTC 2025
NetApp Release 9.16.1P3: Thu Apr 24 02:50:10 UTC 2025
NetApp Release 9.16.1P4: Tue May 27 23:22:56 UTC 2025
NetApp Release 9.16.1P5: Sat Jun 21 02:06:33 UTC 2025
NetApp Release 9.16.1P6: Wed Jul 16 03:10:07 UTC 2025
NetApp Release 9.16.1P7: Thu Aug 21 10:29:10 UTC 2025
NetApp Release 9.16.1P8: Sat Oct 04 03:23:15 UTC 2025
NetApp Release 9.16.1P9: Fri Nov 07 08:49:09 UTC 2025
NetApp Release 9.17.1: Fri Sep 05 00:50:54 UTC 2025
NetApp Release 9.17.1P10: Tue Jul 21 21:51:01 UTC 2026
NetApp Release 9.17.1P2: Fri Nov 07 09:39:01 UTC 2025
NetApp Release 9.17.1P3: Sun Dec 07 04:46:28 UTC 2025
NetApp Release 9.17.1P4: Thu Jan 15 22:33:51 UTC 2026
...
NetApp Release 9.17.1P6: Wed Mar 25 15:38:10 UTC 2026
NetApp Release 9.17.1P7: Mon Apr 20 13:57:24 UTC 2026
NetApp Release 9.17.1P8: Sun May 17 22:59:03 UTC 2026
NetApp Release 9.17.1P9: Wed Jun 24 13:09:36 UTC 2026
NetApp Release 9.17.1RC1: Fri Jul 18 12:39:11 UTC 2025
NetApp Release 9.18.1: Thu Jan 29 07:43:55 UTC 2026
NetApp Release 9.18.1P1: Thu Mar 05 07:06:39 UTC 2026
NetApp Release 9.18.1P2: Sun Mar 29 12:49:32 UTC 2026
NetApp Release 9.18.1P3: Thu May 07 19:01:14 UTC 2026
NetApp Release 9.18.1P4: Thu Jun 04 11:38:00 UTC 2026
NetApp Release 9.18.1P5: Thu Jul 09 23:05:16 UTC 2026
NetApp Release 9.19.1: Sat Jul 18 20:33:10 UTC 2026
NetApp Release 9.19.1: Thu Jul 16 06:07:43 UTC 2026
NetApp Release 9.19.1RC1D2: Sat May 30 08:35:20 UTC 2026
NetApp Release 9.19.1X30: Tue Jun 09 10:08:09 UTC 2026
NetApp Release 9.19.1X39: Thu Jul 09 22:50:24 UTC 2026
NetApp Release 9.19.1X42: Tue Jul 14 08:11:23 UTC 2026
NetApp Release 9.19.1X43: Sat Jul 18 20:33:10 UTC 2026
NetApp Release Cloudstream__9.16.1: Sat Jan 18 14:32:15 UTC 2025
NetApp Release Cloudstream__9.16.1: Sun Oct 19 07:41:54 UTC 2025
NetApp Release Electricjellyfish__9.17.1: Fri Oct 24 06:23:44 UTC 2025
NetApp Release Electricjellyfish__9.17.1: Sat Oct 04 01:37:59 UTC 2025
NetApp Release Kingsue__9.20.1: Wed May 27 07:06:53 UTC 2026
...
.225+|foundation .4+|Capability|Active|Implemented|HTTPS|
|Licensed|Implemented|HTTPS|
|Type|Gap|HTTPS|
|Used|Implemented|HTTPS|
.15+|Disk|Capacity (GB)|Implemented|HTTPS|Used capacity
...
|Originator ID|Implemented|HTTPS|
|Originator Key|Implemented|HTTPS|
.38+|Internal Volume|Compression Enabled|Implemented|HTTPS|Is compression enabled on the storage pool
|Compression Savings|Implemented|HTTPS|ratio of compression savings in percentage
|Data Allocated Capacity|Gap|HTTPS|capacity allocated for data
|Data Used Capacity|Implemented|HTTPS|
|Dedupe Enabled|Implemented|HTTPS|Is dedupe enabled on the storage pool
...
|Version|Implemented|HTTPS|software version
|ManagementIp Addresses|Implemented|HTTPS|
.27+|Storage Pool|Compression Enabled|Implemented|HTTPS|Is compression enabled on the storage pool
|Compression Savings|Implemented|HTTPS|ratio of compression savings in percentage
|Data Allocated Capacity|Gap|HTTPS|capacity allocated for data
|Data Used Capacity|Implemented|HTTPS|
|Dedupe Enabled|Implemented|HTTPS|Is dedupe enabled on the storage pool
...
|Storage Port|Implemented|HTTPS|
|Type|Gap|HTTPS|
.152+|performance .11+|Disk|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
|Key|Implemented|HTTPS|
|Server ID|Implemented|HTTPS|
...
|Utilization Total|Implemented|HTTPS|
|Utilization Write|Implemented|HTTPS|
.35+|Internal Volume|Cache Hit Ratio Total|Implemented|HTTPS|
|Cache Utilization Total|Implemented|HTTPS|
|Total Capacity|Implemented|HTTPS|
|Used Capacity|Implemented|HTTPS|
|Capacity Used Ratio|Implemented|HTTPS|
|Clone Saved Capacity Total|Implemented|HTTPS|
...
|Throughput Total|Implemented|HTTPS|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|HTTPS|
.8+|Qtree|Quota Hard Limit|Implemented|HTTPS|Capacity quota hard limit
|Quota Soft Limit|Implemented|HTTPS|Capacity Quota soft Limit
|Used Capacity|Implemented|HTTPS|
|Total File Count|Implemented|HTTPS|
|IOPs Total|Implemented|HTTPS|
...
.126+|foundation .18+|Disk|Capacity (GB)|Implemented|HTTPS|Used capacity
|Disk Id|Implemented|HTTPS|Uniquely identifies this disk in the array
|Group|Implemented|HTTPS|
|Location|Gap|HTTPS|Where this disk is physically located in the array
|Model|Implemented|HTTPS|
...
|Storage Port|Implemented|HTTPS|
|Type|Gap|HTTPS|
.70+|performance .8+|Disk|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
|Key|Implemented|HTTPS|
|Server ID|Implemented|HTTPS|
...
.64+|foundation .7+|Info|Api Name|Implemented|HTTPS|
|Api Version|Implemented|HTTPS|
|DataSource Name|Implemented|HTTPS|Info
|Date|Implemented|HTTPS|
|Originator ID|Implemented|HTTPS|
...
|Type|Gap|HTTPS|
|Virtual|Implemented|HTTPS|Is this a storage virtualization device?
.31+|performance .6+|Internal Volume|Total Capacity|Implemented||
|Used Capacity|Implemented||
|Capacity Used Ratio|Implemented||
|Key|Implemented||
|Total Objects|Implemented||
...
|Key|Implemented||
|Server ID|Implemented||
.11+|Storage Node|Key|Implemented||
...
|Storage Port|Implemented|HTTPS|
|Type|Gap|HTTPS|
.79+|performance .8+|Disk|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
|Key|Implemented|HTTPS|
|Server ID|Implemented|HTTPS|
...
.79+|foundation .7+|Data Store|Capacity|Implemented|HTTP/S|Snapshot Used capacity in MB
...
|OID|Implemented|HTTP/S|
.4+|NasShare Host|Nas Share OID|Implemented|HTTP/S|
|Host OID|Implemented|HTTP/S|
|OID|Implemented|HTTP/S|
|Read Only|Implemented|HTTP/S|
.5+|LUN|DataStore OID|Implemented|HTTP/S|
|Host OID|Implemented|HTTP/S|
|Number|Implemented|HTTP/S|
|OID|Implemented|HTTP/S|
|Volume Uuid|Implemented|HTTP/S|
.6+|NAS Share|Capacity|Implemented|HTTP/S|Allocated capacity in MB
...
|Type|Gap|HTTP/S|
|Used Capacity|Implemented|HTTP/S|
.16+|VirtualMachine|Dns Name|Implemented|HTTP/S|
...
|Provisioned Capacity|Implemented|HTTP/S|
|Used Capacity|Implemented|HTTP/S|
|Launch Time|Implemented|HTTP/S|
|UUID|Implemented|HTTP/S|
...
|Date|Implemented|HTTP/S|
|Originator ID|Implemented|HTTP/S|
.42+|performance .13+|Host|Total CPU Utilization|Implemented|HTTP/S|
|IOPs Read|Implemented|HTTP/S|Number of read IOPs on the disk
|diskIops.total|Implemented|HTTP/S|
|Disk IOPs write|Implemented|HTTP/S|
|Latency Read|Implemented|HTTP/S|
|Latency Total|Implemented|HTTP/S|
|Latency Write|Implemented|HTTP/S|
|Disk Throughput Read|Implemented|HTTP/S|
|Throughput Read|Implemented|HTTP/S|total disk throughput read
|Disk Throughput Write|Implemented|HTTP/S|
|Key|Implemented|HTTP/S|
|Total Memory Utilization|Implemented|HTTP/S|
|Server ID|Implemented|HTTP/S|
.14+|Virtual Disk|Total Capacity|Implemented|HTTP/S|
|Used Capacity|Implemented|HTTP/S|
|Capacity Used Ratio|Implemented|HTTP/S|
|IOPs Read|Implemented|HTTP/S|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTP/S|
|IOPs Write|Implemented|HTTP/S|
|Key|Implemented|HTTP/S|
|Latency Read|Implemented|HTTP/S|
|Latency Total|Implemented|HTTP/S|
|Latency Write|Implemented|HTTP/S|
|Server ID|Implemented|HTTP/S|
|Throughput Read|Implemented|HTTP/S|
|Throughput Total|Implemented|HTTP/S|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|HTTP/S|
.15+|vm|Total Capacity|Implemented|HTTP/S|
|Used Capacity|Implemented|HTTP/S|
|Capacity Used Ratio|Implemented|HTTP/S|
|IOPs Read|Implemented|HTTP/S|Number of read IOPs on the disk
|diskIops.total|Implemented|HTTP/S|
...
.124+|foundation .14+|Disk|Capacity (GB)|Implemented|HTTP/S|Used capacity
...
.5+|File Share|Is InternalVolume|Implemented|HTTP/S|whether the file share represents an internal volume (netapp volume) or is it a qtree/folder within the internal volume
|Is Shared|Implemented|HTTP/S|whether this fileShare has any shares associated with it
|Name|Implemented|HTTP/S|
|Path|Implemented|HTTP/S|Path of the fileShare
...
.3+|Share|IP Interfaces|Implemented|HTTP/S|comma separated list of IP addresses on which this share is exposed
|Name|Implemented|HTTP/S|
|Protocol|Implemented|HTTP/S|enum for share protocol
.2+|Share Initiator|Initiator|Implemented|HTTP/S|
|Permission|Implemented|HTTP/S|Permissions for this particular share
.13+|Storage|Display IP|Implemented|HTTP/S|
|Failed Raw Capacity|Implemented|HTTP/S|Raw capacity of failed disks (sum of all disks that are failed)
|Family|Implemented|HTTP/S|The storage Family could be Clariion, Symmetrix, et al
|IP|Implemented|HTTP/S|
...
|State|Implemented|HTTP/S|free text describing the device state 
|UUID|Implemented|HTTP/S|
.23+|Storage Pool|Auto Tiering|Implemented|HTTP/S|indicates if this storagepool is participating in auto tiering with other pools
...
|Storage Port|Implemented|HTTP/S|
|Type|Gap|HTTP/S|
.61+|performance .3+|Disk|IOPs Total|Implemented||
|Key|Implemented||
|Server ID|Implemented||
.12+|Internal Volume|Total Capacity|Implemented||
|Used Capacity|Implemented||
|Capacity Used Ratio|Implemented||
|Total Compression Savings|Implemented||
|Compression Savings Space|Implemented||
...
|Key|Implemented||
|Server ID|Implemented||
.14+|Storage|Cache Hit Ratio Total|Implemented||
|Failed Raw Capacity|Implemented||
|Raw Capacity|Implemented||
|Spare Raw Capacity|Implemented||Raw capacity of spare disks (sum of all disks that are spare)
|StoragePools Capacity|Implemented||
...
|Snapshot Used Capacity|Implemented||
|Snapshot Used Capacity Ratio|Implemented|| Reported as a time series
.6+|Volume|Raw Capacity|Implemented||
|Total Capacity|Implemented||
|Used Capacity|Implemented||
|Capacity Used Ratio|Implemented||
|Key|Implemented||
...
.44+|performance .14+|Storage|Failed Raw Capacity|Implemented||
|Raw Capacity|Implemented||
|Spare Raw Capacity|Implemented||Raw capacity of spare disks (sum of all disks that are spare)
|StoragePools Capacity|Implemented||
|IOPs other|Implemented||
...
|Snapshot Used Capacity|Implemented||
|Snapshot Used Capacity Ratio|Implemented|| Reported as a time series
.19+|Volume|Raw Capacity|Implemented||
|Total Capacity|Implemented||
|Used Capacity|Implemented||
|Written Capacity|Implemented||
|Capacity Used Ratio|Implemented||
...
.80+|foundation .10+|Disk|Capacity (GB)|Implemented|HTTPS|Used capacity
|Disk Id|Implemented|HTTPS|Uniquely identifies this disk in the array
|Location|Gap|HTTPS|Where this disk is physically located in the array
|Model|Implemented|HTTPS|
|Name|Implemented|HTTPS|
...
|Date|Implemented|HTTPS|
|Originator ID|Implemented|HTTPS|
.15+|Internal Volume|Compression Enabled|Implemented|HTTPS|Is compression enabled on the storage pool
|Compression Savings|Implemented|HTTPS|ratio of compression savings in percentage
|Data Used Capacity|Implemented|HTTPS|
|Dedupe Enabled|Implemented|HTTPS|Is dedupe enabled on the storage pool
|Internal Volume Id|Implemented|HTTPS|
...
|Virtual|Implemented|HTTPS|Is this a storage virtualization device?
|UUID|Implemented|HTTPS|
.8+|Storage Node|Model|Implemented|HTTPS|
|Name|Implemented|HTTPS|
|Serial Number|Implemented|HTTPS|
|State|Implemented|HTTPS|free text describing the device state 
|UUID|Implemented|HTTPS|
...
|Type|Gap|HTTPS|
|Virtual|Implemented|HTTPS|Is this a storage virtualization device?
.57+|performance .21+|Internal Volume|Total Capacity|Implemented|HTTPS|
|Used Capacity|Implemented|HTTPS|
|Capacity Used Ratio|Implemented|HTTPS|
|Total Compression Savings|Implemented|HTTPS|
|Compression Savings Space|Implemented|HTTPS|
...
|Throughput Total|Implemented|HTTPS|Average disk total rate (read and write across all disks) in MB/s
|Throughput Write|Implemented|HTTPS|
.3+|Qtree|IOPs Total|Implemented|HTTPS|
|Key|Implemented|HTTPS|
|Server ID|Implemented|HTTPS|
.16+|Storage|Failed Raw Capacity|Implemented|HTTPS|
|Raw Capacity|Implemented|HTTPS|
...
|Virtual|Implemented|HTTPS|Is this a storage virtualization device?
|Effective Used Capacity Percent|Implemented|HTTPS|
.38+|performance .13+|Storage|Failed Raw Capacity|Implemented|HTTPS|
|Raw Capacity|Implemented|HTTPS|
|Spare Raw Capacity|Implemented|HTTPS|Raw capacity of spare disks (sum of all disks that are spare)
|StoragePools Capacity|Implemented|HTTPS|
|IOPs other|Implemented|HTTPS|
...
|VAST Data
| Build version: release-5.3.3-hf5-2058254
 Build version: release-5.3.3-hf7-2198162
 Build version: release-5.3.3-sp3-2009124
 Build version: release-5.4.3-sp2-hf24-2483981
System version: 5.3.3.0.10090135699003918747
System version: 5.3.3.1.3876442573258902143
System version: 5.4.3.1.1891089545684643723
...
.109+|foundation .14+|Disk|Capacity (GB)|Implemented|HTTPS|Used capacity
|Disk Id|Implemented|HTTPS|Uniquely identifies this disk in the array
|Location|Gap|HTTPS|Where this disk is physically located in the array
|Model|Implemented|HTTPS|
|Name|Implemented|HTTPS|
...
|Qtree Id|Implemented|HTTPS|unique id of the qtree
|Type|Gap|HTTPS|
.7+|Quota|Hard Capacity Limit (MB)|Implemented|HTTPS|max amount of disk space, allowed for the quota target (Hard limit)
|Internal Volume Id|Implemented|HTTPS|
|Quota Id|Implemented|HTTPS|unique id of the quota
|Soft Capacity Limit (MB)|Implemented|HTTPS|Maximum amount of disk space, allowed for the quota target
|Type|Gap|HTTPS|
...
|Used Capacity|Implemented|HTTPS|
.1+|VirtualMachine Internal Volume Ref|Internal Volume Id|Implemented|HTTPS|
.88+|performance .8+|Disk|IOPs Read|Implemented|HTTPS|Number of read IOPs on the disk
|IOPs Total|Implemented|HTTPS|
|IOPs Write|Implemented|HTTPS|
|Key|Implemented|HTTPS|
|Server ID|Implemented|HTTPS|
...
|Key|Implemented|HTTPS|
|Server ID|Implemented|HTTPS|
.19+|Storage|Failed Raw Capacity|Implemented|HTTPS|
|Raw Capacity|Implemented|HTTPS|
|Spare Raw Capacity|Implemented|HTTPS|Raw capacity of spare disks (sum of all disks that are spare)
|StoragePools Capacity|Implemented|HTTPS|
|IO Density Read|Implemented|HTTPS|
...
|Throughput Write|Implemented|HTTPS|
|Utilization Total|Implemented|HTTPS|
.18+|StoragePool Disk|Capacity Provisioned|Implemented|HTTPS|
|Raw Capacity|Implemented|HTTPS|
|Reserved Capacity|Implemented|HTTPS|Fractional reserved (included in data allocated capacity)
|Total Capacity|Implemented|HTTPS|
|Used Capacity|Implemented|HTTPS|
...
.74+|foundation .8+|Data Store|Capacity|Implemented|Web Services|Snapshot Used capacity in MB
|MOID|Implemented|Web Services|
|Name|Implemented|Web Services|
|OID|Implemented|Web Services|
...
|Used Capacity|Implemented|Web Services|
.17+|VirtualMachine|Dns Name|Implemented|Web Services|
...
|Provisioned Capacity|Implemented|Web Services|
|Used Capacity|Implemented|Web Services|
|Launch Time|Implemented|Web Services|
...
|Date|Implemented|Web Services|
|Originator ID|Implemented|Web Services|
.60+|performance .19+|Host|Total CPU Utilization|Implemented|Web Services|
...
.14+|Virtual Disk|Total Capacity|Implemented|Web Services|
|Used Capacity|Implemented|Web Services|
...
.27+|vm|Total Capacity|Implemented|Web Services|
|Used Capacity|Implemented|Web Services|
|Capacity Used Ratio|Implemented|Web Services|
...
.93+|foundation .8+|Data Store|Capacity|Implemented|Web Services|Snapshot Used capacity in MB
|MOID|Implemented|Web Services|
|Name|Implemented|Web Services|
|OID|Implemented|Web Services|
|Provisioned Capacity|Implemented|Web Services|
