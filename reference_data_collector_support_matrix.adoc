...
.86+|foundation .9+|Disk|Capacity (GB)|Implemented|HTTPS|
...
.2+|Storage Node|Name|Implemented|HTTPS|
|UUID|Implemented|HTTPS|
.13+|Storage Pool|Include In Dwh Capacity|Implemented|HTTPS|
|Name|Implemented|HTTPS|
...
.18+|Volume|AutoTier Policy Identifier|Implemented|HTTPS|
...
.4+|foundation .4+|Info|DataSource Name|Implemented|HTTP/S|Info
|Date|Implemented|HTTP/S|
|Originator ID|Implemented|HTTP/S|
|Originator Key|Implemented|HTTP/S|
.15+|performance .4+|Storage Node Data|Cache Hit Ratio Total|Implemented|SSH|
|Key|Implemented|SSH|
|Server ID|Implemented|SSH|
|Utilization Total|Implemented|SSH|
...
.110+|foundation .15+|Disk|Capacity (GB)|Implemented||
|Disk Id|Implemented||
|Group|Implemented||
|Location|Gap||
|Model|Implemented||
...
|Virtual|Implemented|HTTPS|
|UUID|Implemented|HTTPS|
.7+|Storage Node|Cache Size|Implemented|HTTPS|
|Model|Implemented|HTTPS|
|Name|Implemented|HTTPS|
|State|Implemented|HTTPS|
|UUID|Implemented|HTTPS|
