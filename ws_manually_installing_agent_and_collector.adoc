...
.. Note: The agent installer should be downloaded to a folder that is different from the folder containing the running agent.
...
+
For example, if the agent is running in “/test_user/apps”, the command would be:
+
