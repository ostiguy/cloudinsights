...
summary: Modify existing queries by changing criteria and columns, with flexible save options to update, rename, or create new versions, plus options to delete queries when no longer needed.
...
[.lead]
Manage your queries effectively by modifying search criteria, adding or removing columns, and choosing from flexible save options. Update existing queries, create new versions, or delete queries that are no longer needed to keep your query library organized and current.
