...
summary: Access Workload Security data through a REST API with secure token-based authentication to integrate with CMDBs, ticketing systems, and other enterprise applications.
---
