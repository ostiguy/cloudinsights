...
[.lead]
Data Infrastructure Insights provides comprehensive support options including self-service resources, community forums, documentation, and technical support. Access these support resources by selecting *Help > Support*, and consider activating your support entitlement to unlock full technical assistance via web tickets and phone support. 

image:SupportPageExample.png[Support page, width=600]
...
It is highly recommended that you check the box to allow a NetApp Support Engineer access to your Data Infrastructure Insights site during your support session. This will allow the engineer to troubleshoot the problem and help you resolve it quickly. While the Support Engineer has access to your site, they will be able to perform all Admin-level functions. 

When your issue is resolved or your support session has ended, you can un-check the box. 

You can request support by going to the link:https://www.netapp.com/support-and-training/[NetApp Support Site]. You must have an active Data Infrastructure Insights subscription.
