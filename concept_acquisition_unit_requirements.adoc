...
|Operating system	
a|A computer running a licensed version of one of the following:
...
|Memory	|8 GB RAM 
| Same
|Available disk space	a|50 GB (100 GB recommended)
...
Your file system may use some space for its overhead. These are the minimum spaces that should be _available_ before installation. 
