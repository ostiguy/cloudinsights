...
summary: Access the Reporting database directly through APIs, bypassing Cognos for custom integrations, automated reporting, and advanced data analysis workflows.
...
[.lead]
Access the Data Infrastructure Insights Reporting database directly through OData v4-compliant APIs, bypassing the Cognos interface for greater flexibility. This enables custom integrations, automated reporting workflows, and advanced data analysis for users who need programmatic access to their infrastructure data.
...
To learn more, check out link:https://www.odata.org/getting-started/basic-tutorial/[this tutorial] on OData. 
